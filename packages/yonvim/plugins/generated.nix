...
_self: {
  ...
  bufferline-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-VjusgJ3nEc+P/3bRjdS93qAErn6PZh7YkAAjxFF6Dxk=";
    };
  ...
  dressing-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-LlcE/1/IT6QW/o5gks80BFnrIdBd4GjW4M9o+84/j1c=";
    };
  ...
  flash-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-dM3hk/wutaRHMlGiKVQoXmgj7ycV/TCorfhdSNv4OBI=";
    };
  ...
  gitsigns-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-nHUQoYo/4J2rh494UxYz3hqrrgPSxX4IgManKxCsBR8=";
    };
  ...
  lualine-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-uNDRynWs7fXDDzDFKvE31oDetv3aabiJfr/r/84z9Sg=";
    };
  ...
  nvim-colorizer-lua = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-Qw7IcfM3N+7ml98ExMPBszDz9FwJPtmrVqrVDa0TJKQ=";
    };
  ...
  nvim-notify = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-wxyHwL/uFdp6w32CVHgSOWkzRrIRuFvWh+J2401RAAA=";
    };
  ...
  nvim-treesitter-textobjects = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-/NY5hHwNmHEBHUWOX4qX9QCHPJU8grWsaEtD+pAXDjE=";
    };
  ...
  nvim-ts-autotag = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-V6uJG/tUL1lFc+yOKzL+AmdG3QqLllk/uYogxwxiaXQ=";
    };
  ...
  rainbow-delimiters-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-0GcL4uU5p9DpS5X90UXHRG/5gWTWjy9ZMWOOKwvuBow=";
    };
  ...
  rustaceanvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-fOQHvblEX4Oz2M2Git0ZFQKHF+FbeHmNu+BEL4lrtTs=";
    };
  ...
  vim-illuminate = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-DdJzTHxoOv+vjFymETa2MgXpM/qDwvZjpoo1W8OOBj0=";
    };
  ...
  zen-mode-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-iHGsnFG1PBup3/+JbSwXf/TerQ7PNXkp9gKVznmRbTE=";
    };
