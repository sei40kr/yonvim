...
_self: {
  ...
  diffview-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-UCESOnaVwRwKfK0WB0/woKc+3zr1vqBTMckSiUxD2Ls=";
    };
  ...
  flash-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "folke";
      repo = "flash.nvim";
      rev = "30a6385c92cc37822eb701c6984d6ba9cbd6f1ab";
      hash = "sha256-qE+qQ/urO1OG+1aAl4f0Ww0rGyAel6hz4whSJjplaGI=";
    };
  ...
  mason-lspconfig-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-yvX4DzOlvxITdfw6h/CIRxRjOXPSxMPhxSD3KyT5mXs=";
    };
  ...
  octo-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-e8mEotAOdpCci3aKlKZnC4jDPb9LORdg1oD9HGqCmiQ=";
    };
  ...
  telescope-file-browser-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-E4RMyNqKTuY/biNeT5xtFRupOxf+Q9wHREBVM32dORc=";
    };
  ...
  telescope-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-BPDgzjPnDxKo1vN07CY8UC88cRpKYFqKwmMaXOaumL4=";
    };
  ...
  toggleterm-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-MkCjGyKmPp8JB1g+cG+ElwYAgqiig1OfQQOXOkqWGVE=";
    };
